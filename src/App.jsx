...
import NameLetters from './motion/NameLetters';
...
function Hero() {
  ...
  return (
    <section className="hero wrap" aria-labelledby="hero-title">
      ...
      <div className="hero-bottom" data-collapse-piece>
        <div className="hero-intro"><p>Software developer.<br />Computing student in Sydney.</p></div>
        <div className="hero-context">
          <p>I make games and build tools.<br />Previously, I co-led the Sydney Computing Society.</p>
        </div>
      </div>
    </section>
  );
    ...
    <section id="experience" className="experience-section" aria-labelledby="experience-title">
      <div className="experience wrap">
        ...
        <div className="experience-entries">
          {experience.map((item, index) => <article className="experience-row" data-collapse-piece key={item.org}>
  ...
  return (
    <section id="leadership" className="community-section" aria-labelledby="community-title">
      <div className="community wrap">
        <div className="community-intro" data-collapse-piece>
        ...
        <div className="community-grid">
          {leadership.map((org, index) => <article data-collapse-piece className={`community-row ${index === 0 ? 'community-featured' : ''}`} key={org.org}>
...
function Contact() {
  return <footer id="contact" className="contact">
    <div className="wrap contact-content">
      <h2 data-collapse-piece>Get in <TouchWord /></h2>
